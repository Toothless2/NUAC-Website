...
class CommitteesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post committees_url, params: { committee: { description: @committee.description, name: @committee.name, role: @committee.role } }
    end
  ...
  test "should update committee" do
    patch committee_url(@committee), params: { committee: { description: @committee.description, name: @committee.name, role: @committee.role } }
